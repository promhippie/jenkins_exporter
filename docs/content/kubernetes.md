...
resources:
  - github.com/promhippie/jenkins_exporter//deploy/kubernetes?ref=master
...
{{< highlight yaml >}}
images:
  - name: quay.io/promhippie/jenkins-exporter
    newTag: 1.1.0
{{< / highlight >}}
...
helm show values promhippie/jenkins-exporter
...
[helm]: https://helm.sh
[chart]: https://github.com/promhippie/charts/tree/master/stable/jenkins-exporter
[ahub]: https://artifacthub.io/packages/helm/promhippie/jenkins-exporter
